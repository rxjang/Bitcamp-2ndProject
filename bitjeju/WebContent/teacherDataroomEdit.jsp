...
<%@ include file="template/menu.jspf" %>
   ...
   <!--*****************lms메뉴******************-->
       ...
       <h2>자료실</h2>
	       <div id="drtable">
	       <form method="post" action="lmsteacherdredit.bit" enctype="multipart/form-data">
	       	<table>
	       	<c:set value="${bean }" var="bean" />
	       		<tr>
	       			<th>제목<input type="hidden" name="drNum" value="${bean.drNum }"/></th>
	       	...
	       	<a href="#" onClick="window.history.go(-1)" class="btn2">취소</a>
